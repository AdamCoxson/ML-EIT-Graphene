...
def mesh_gen(n_el=20, num_per_el=3, start_pos='left', el_width=0.1):
    ''' 
    ...
    def _fh(pts):
        p_fix, el_pos = fix_electrodes_multiple(edgeX=0.1, edgeY=0.1, a=2, b=2, ppl=n_el, el_width=el_width, num_per_el=num_per_el, start_pos=start_pos)
    ...
    p_fix1, el_pos = fix_electrodes_multiple(edgeX=0.1, edgeY=0.1, a=2, b=2, ppl=n_el, el_width=el_width, num_per_el=num_per_el, start_pos=start_pos)
...
def mesh(n_el=20, num_per_el=3, start_pos='left'):
    # generate and extract meshing
    el_width = 0.1
    mesh_dict = mesh_gen(n_el=n_el, num_per_el=num_per_el, start_pos=start_pos,el_width=el_width)
    p = mesh_dict['p']
    t = mesh_dict['t']
