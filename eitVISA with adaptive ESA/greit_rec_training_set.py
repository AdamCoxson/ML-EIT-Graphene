...
Authors: Adam Coxson and Ivo Mihov, MPhys Undergrads, The University of Manchester
Project: Automated Electrical Impedance Tomography of Graphene
Module:  greit_rec_training_set


This script contains some redundant functions that have been superseded by
current_matrix_generator and volt_matrix_generator, but may still be called
within the code somewhere.
