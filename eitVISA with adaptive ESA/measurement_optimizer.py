...
def find_all_distances(rec, h_mat, el_coords, n_el, a = 2., npix = 64, cutoff = 0.8):
	...
	c_sq = get_centre_squares(npix = npix, a = 2.)
	#print(el_coords)
...
def findNextVoltagePair(new_ex_line, jac_file, total_map, number_of_voltages, counter, npix=128, cutoff=0.97):
	...
	C_sq = get_centre_squares(npix=npix)
